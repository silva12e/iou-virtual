...
<div class="container">
    ...
    <div class="row" style="padding-top:40px;color:white">
        <div class="col-md-12">
            <h1 class="main-h" style="font-family: 'Concert One', cursive;
                color:#00303f;"><img  src="{{url('/img/iou-logo.png')}}" alt="Image"/>I.O.U. - Virtual Currency Transactions
            </h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="panel" style="margin-top:80px;" >
                <div class="panel-heading" style="background-color: #4484ce;color:#fff;" >
