...
<head>
    ...
    <title>IOU - Virtual Currency Exchange</title>
        ...
        <nav class="navbar navbar-default navbar-static-top" style="background-color: black" >
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a style="font-family: 'Dosis', sans-serif;" class="navbar-brand" href="{{ url('/') }}" style="">
                        I.O.U. 
                    </a>
                </div>
                        ...
                        @else
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href=""><i class="glyphicon glyphicon-user"></i> Notifications</a>
                                    </li>
                                    <li>
